...
results_alpha_opt_list = []
results_OE_average_list = []
results_OE_SD_list = []
results_OE_RMSD_opt_list = []
    ...
    for sample_size in sample_size_list:
        ...
        for random_subsample_size in random_subsample_size_list:
            ...
            if sample_size>=random_subsample_size:
                ...
                results_alpha_opt_list.append(alpha_opt)
                results_OE_average_list.append(OE_average)
                results_OE_SD_list.append(OE_SD)
                results_OE_RMSD_opt_list.append(OE_RMSD_opt)
                ...
                file_name = results_directory_name + "L.%s_fRNAdb_NC_sampling_sample_size.%s_random_subsample_size.%s_optimised_neutral_component_and_network_size_estimates.txt" % (L,sample_size,random_subsample_size)
                f = open(file_name,"w")
...
table = [[results_L_list[i],
         ...
         results_alpha_opt_list[i],
         results_OE_average_list[i],
         results_OE_SD_list[i],
         results_OE_RMSD_opt_list[i],
         results_OE_rel_RMSD_list[i]] for i,x in enumerate(results_L_list)]
file_name = results_directory_name + "fRNAdb_NC_sampling_optimised_neutral_network_size_estimates_comparison_results.txt"
f = open(file_name,"w")
f.write(tabulate(table,headers=["L","sample size","random subsample size","opt. alpha","OE average","OE SD","opt. OE RMSD","OE rel. RMSD"]))
f.close()
